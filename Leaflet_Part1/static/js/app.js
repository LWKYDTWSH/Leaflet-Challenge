...
//Assign colors for lower mag  starting at green, higher mag will be red.
...
function createMap(earthquakes) {
  ...
  // Apply baseMaps and overlayMaps
  ...
  // Create the legend to show map information.
